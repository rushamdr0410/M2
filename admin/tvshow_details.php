    ...
    <div class="movie-details-container">
        ...
        <div class="movie-info">
            ...
            <div class="button-container">
                <a href="videoplayer_kungfu.php?tmdb_id=<?php echo $tmdb_id; ?>&media_type=tv" class="watch-btn">
                    <i class="fas fa-play"></i> Watch Now
                </a>
                <a href="trailer.php?tmdb_id=<?php echo $tmdb_id; ?>&media_type=tv" class="trailer-btn">
