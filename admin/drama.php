...
$movies_url = "$tmdb_base_url/discover/movie?api_key=$tmdb_api_key&with_genres=$drama_genre_id&sort_by=popularity.desc";
$movies_data = fetch_tmdb_data($movies_url);
$drama_movies = $movies_data['results'] ?? [];

// Fetch action TV shows from TMDb
$tv_url = "$tmdb_base_url/discover/tv?api_key=$tmdb_api_key&with_genres=$drama_genre_id&sort_by=popularity.desc";
