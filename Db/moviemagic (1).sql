...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2024 at 07:37 AM
...
INSERT INTO `moviedetails` (`id`, `title`, `description`, `genreid`, `release_year`, `duration`, `type`, `poster_img`, `quality`) VALUES
(9, 'Kung Fu Panda 4', 'After Po is tapped to become the Spiritual Leader of the Valley of Peace, he needs to find and train a new Dragon Warrior, while a wicked sorceress plans to re-summon all the master villains whom Po has vanquished to the spirit re...', 5, 2024, '94 min', 'Movie', 'kungfupanda4.jpg', 'CAM'),
(11, 'Dune ', '', 5, 2024, '94', 'Movie', 'Dune.jpeg', 'CAM'),
(14, 'Halo', 'halo', 5, 2024, '94', 'Movie', 'Halo.jpeg', 'CAM');
